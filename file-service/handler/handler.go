...
func (h *Handler) Run(cfg *config.Config) error {
...
func (h *Handler) saveUserImageHandler(w http.ResponseWriter, req *http.Request) {
    ...
    imagePath, saveHttpErr := h.services.UserImageService.SaveUserImageHandler(userId, req)
    if saveHttpErr != nil {
...
func (h *Handler) getUserImageHandler(w http.ResponseWriter, req *http.Request) {
    ...
    imageData, getImageHttError := h.services.UserImageService.GetUserImageHandler(cleanPath)
