...
export default function LoginPage() {
  ...
  <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
	...
	Email 
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="supermail@gmail.com"/>
    </div>
    <div class="mb-6">
